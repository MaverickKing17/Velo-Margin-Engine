...
export const MOCK_LISTINGS: CarListing[] = [
  ...
  {
    id: '6',
    title: '2022 Porsche 911 GT3 (GT Silver)',
    make: 'Porsche',
    model: '911 GT3',
    year: 2022,
    trim: 'PDK',
    ...
    region: 'Oakville',
    dealerName: 'Porsche Centre Oakville',
    ...
    description: 'GT Silver Metallic over Black. Driver-focused mileage. Well maintained, one owner.',
    vibeScore: 81,
